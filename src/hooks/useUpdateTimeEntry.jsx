...
export const useUpdateTimeEntry = () => {
  ...
  const updateInsert = async (dias, description, idCategory, timeEntryId) => {
    try {
      if (!token) {
      ...
      const urlInsert =
        "https://testapp.sophossolutions.com/SophosApiChronus/api/dbo/User/UpdateTimeEntry";
      const headers = {
      ...
      const response = await axios.put(urlInsert, body, { headers });
  ...
  return { insert, loading, updateInsert };
};
